...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={`rounded-xl border border-shield-cyan/15 bg-shield-navy-light/50 p-6 shadow-xl shadow-shield-cyan/5 ${className || ""}`}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={`text-sm text-shield-muted ${className || ""}`}
    {...props}
  />
))
